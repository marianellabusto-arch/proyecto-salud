...
- Editá los textos de `inicio/inicio.html` para adaptar la landing a tu proyecto.
- Cambiá colores, tipografías y espaciados en `inicio/inicio.css`.
- Ajustá la lógica principal de la landing en `inicio/inicio.js`.
- Si querés modificar autenticación o validaciones, revisá los archivos dentro de `login`, `registro` y `verificacion`.
